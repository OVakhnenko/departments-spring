    ...
    <form:form method="POST" commandName="employee" action="${formAction}">
        ...
        <tr>
            <td>
                ...
                <form:input path="department.name" id="nameDepInput" readonly="true" disabled="true"></form:input>
        ...
        <c:if test="${employee.employee_id > 0}">
            <tr>
                <td>
                    ...
                    <form:input path="employee_id" id="idEmpInput" readonly="true" disabled="true"></form:input>
